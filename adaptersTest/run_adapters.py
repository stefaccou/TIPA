...
def main():
    ...
    if task == "paws-x":
        ...
        def encode_batch(examples):
            ...
            for sentence1, sentence2 in zip(examples["sentence1"], examples["sentence2"]):
                encoded = tokenizer(sentence1, sentence2, max_length=60, truncation=True, padding="max_length")
    ...
    if none_tr:
        ...
        model.active_adapters = Stack(
            train_lang, task
        )  # Source language adapter also activated for training (all other setups)
...
if __name__ == "__main__":
    parameters = {
        ...
        "slurm_time": "03:05:00",
        "slurm_job_name": "eplication adapter code from paper",
